...
const userLinks = [
  ...
  { href: "/dashboard/user?tab=bookmarks", label: "Bookmarks", icon: "M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" },
];
...
const writerLinks = [
  ...
  { href: "/dashboard/writer?tab=bookmarks", label: "Bookmarks", icon: "M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" },
];
      ...
      <div className="sticky top-16 p-4">
        ...
        {role !== "user" && (
          <div className="mt-4 border-t border-gray-100 pt-4">
            <p className="mb-2 px-3 text-xs font-semibold uppercase tracking-wider text-gray-400">Other Dashboards</p>
            {role === "admin" && (
              <Link href="/dashboard/user" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-dark">
                User View
              </Link>
            )}
            {role === "admin" && (
              <Link href="/dashboard/writer" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-dark">
                Writer View
              </Link>
            )}
            {role === "writer" && (
