      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          >
            ...
            <h3 className="mb-2 text-xl font-bold text-dark">Our Mission</h3>
          ...
          >
            ...
            <h3 className="mb-2 text-xl font-bold text-dark">For Readers</h3>
            <p className="text-gray-600">
          ...
          >
            ...
            <h3 className="mb-2 text-xl font-bold text-dark">For Writers</h3>
            <p className="text-gray-600">
