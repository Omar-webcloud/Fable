...
function BrowseContent() {
  ...
  }, [debouncedSearch, genre, sort, minPrice, maxPrice, page]);
  ...
  useEffect(() => {
    setPage(1);
  }, [debouncedSearch, genre, sort, minPrice, maxPrice]);
    ...
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <div className="mb-8 rounded-xl bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
          <select
            value={genre}
        ...
        <div className="mt-3 flex items-center gap-4">
          ...
          <input
            ...
            className="w-24 rounded-lg border border-gray-300 px-3 py-1.5 text-sm outline-none focus:border-primary"
            min="0"
          />
          ...
          <input
            ...
            min="0"
          />
          {(search || genre || minPrice || maxPrice || sort !== "newest") && (
            <button
              onClick={() => { setSearch(""); setGenre(""); setMinPrice(""); setMaxPrice(""); setSort("newest"); }}
      ...
      {!loading && ebooks.length === 0 && (
        <div className="py-20 text-center">
          ...
          <h3 className="text-lg font-semibold text-dark">No ebooks found</h3>
      ...
      {pagination.pages > 1 && (
        <div className="mt-10 flex items-center justify-center gap-2">
          <button
            ...
            disabled={page <= 1}
            className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium transition hover:bg-gray-50 disabled:opacity-40"
          >
            Previous
          </button>
